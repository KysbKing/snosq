...
if a!="Mertv89":
	print(colored(f"Пароль не верен! Завершаю работу программы! ", 'blue'))
	print(colored(f"Уточни его у создателей", 'blue'))
	exit()
else:
	print(colored(f"Пароль верен! Запускаю программу.", 'green'))

# ASCII-арт приветствия
ascii_banner = pyfiglet.figlet_format("Mertv")
colored_banner = colored(ascii_banner, color='blue')  # Красим в цвет
